...
class Sound
    ...
    @files = 
        ...
        BOT_JUMP:          file: "bot_jump.wav"            volume: 0.1
        ...
        ATOM_DIGEST:       file: "atom_digest.wav"         volume: 0.5
        MENU_FADE:         file: "stone_land.wav"          volume: 1.0
        MENU_ITEM:         file: "menu_item.wav"           volume: 0.5
        MENU_SELECT:       file: "menu_select.wav"         volume: 0.5
